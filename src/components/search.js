  ...
  return (
    <div className='max-w-sm rounded overflow-hidden my-10 mx-auto'>
      ...
      <div className="flex items-center border-b-2 border-purple-500 py-2">
        ...
        <button className="flex-shrink-0 bg-purple-400 hover:bg-purple-700 
                        border-purple-300 hover:border-purple-300 text-sm border-4 text-white py-2 px-4 rounded-full shadow-lg" type="submit">
                        Search
</button>
